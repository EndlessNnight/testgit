...
class OSS {
    ...
    public function __construct($isInternal = false)
    {
        ...
        $this->city = config('filesystems.disks.oss.city');
    ...
    public function serviceUploadToOSS($ossPath, $filePath, $options=[]){
        $oss = new OSS();
        $oss->ossClient->setBucket($this->bucket);
        return $oss->ossClient->uploadFile($ossPath, $filePath, $options);
    }
